...
> שני הסקילים נכתבו מהקוד שעובד ומשוכפלים ל-`.github/skills/` ול-`.claude/skills/`.
> ⚠️ הם מתעדים גם את המגבלות שנמדדו בפועל (אין מודל סמנטי, `var` אינו מזוהה, מימוש ממשק
> נראה כירושה) ולא רק את מה שעובד — מגבלה שאינה כתובה מתגלה כבאג בציון של תלמידה.
