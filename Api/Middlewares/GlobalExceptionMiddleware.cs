...
//                await _next(context);
//            }
//            catch (AppValidationException ex)   // 400 - Validation
//            {
...
//                await WriteProblemDetailsAsync(context, problem);
//            }
//            catch (UniqueConstraintException ex)  // 409 - Conflict (duplicate)
//            {
...
//                    Title = "Conflict – duplicate value.",
//                    Detail = ex.Message,
...
//                await WriteProblemDetailsAsync(context, problem);
//            }
//            catch (Exception ex)               // 500 - Everything else
//            {
